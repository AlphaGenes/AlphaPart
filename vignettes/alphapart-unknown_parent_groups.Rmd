...
If the mean EBV of the founder's is not zero, then the partitioning of genetic trends will be affected. This is because the method assumes the EBV to be relative to the base population, thus the mean of the founder's to be 0. To resolve, there are two options:
