...
The package includes the main function `AlphaPart`
for partitioning genetic values and
auxiliary functions for manipulating data and summarizing, visualizing, and
saving results.
